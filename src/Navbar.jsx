  ...
  return (
    <nav style={{ 
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "40px" }}>
        <div style={{ fontSize: "1.5rem", fontWeight: "900", fontFamily: "'Montserrat', sans-serif", cursor: "pointer" }} onClick={() => onCategoryClick("All")}>
          <span style={{ color: "white" }}>KHUSHI'S</span>
      ...
      <div style={{ flex: 1, maxWidth: "500px", margin: "0 20px" }}>
        <input 
          ...
          style={{ width: "100%", padding: "10px 20px", borderRadius: "5px", border: "1px solid #444", background: "#2a2a2a", color: "white", outline: "none" }}
        />
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "25px", fontSize: "0.8rem", fontWeight: "bold" }}>
        {/* Wishlist */}
        <div onClick={onWishlistClick} style={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer" }}>
        ...
        <div onClick={onCartClick} style={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer", position: "relative" }}>
          ...
          <span>Bag</span>
          {cartCount > 0 && (
            <span style={{ position: "absolute", top: "-5px", right: "0px", background: "#cf6679", color: "white", borderRadius: "50%", width: "18px", height: "18px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.7rem", fontWeight: "bold" }}>
              {cartCount}
            </span>
          )}
        </div>
